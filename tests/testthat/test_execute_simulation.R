...
test_that("simulation handles imput errors", {
    ...
    expect_error(execute_simulation(trials_per_level=1,
                            n_nodes=matrix_,
                            clique_fraction=c(1),
                            alpha=c(1)))
    expect_error(execute_simulation(trials_per_level=1,
    ...
    expect_error(execute_simulation(trials_per_level=1,
                            ...
                            clique_fraction=c(1),
                            alpha=matrix_))
    expect_error(execute_simulation(trials_per_level=1.2,
                            n_nodes=c(10),
                            clique_fraction=c(1),
                            alpha=c(1)))
}
...
test_that("simulation outputs a data frame", {
    expect_true(class(execute_simulation(trials_per_level=1,
                           n_nodes=c(10),
                           clique_fraction=c(1),
