...
knitr::include_graphics("hw3_scrn_1.png")
```
...
knitr::include_graphics("hw3_scrn_2.png")
...
<span style="color:blue">I am not sure. I have some code in python. I am thinking about taking some scripts I wrote to analyze sport/activity gps and heart rate data in python and transferring that to R code. </span>
